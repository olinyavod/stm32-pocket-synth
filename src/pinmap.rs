...
#[cfg(feature = "mcu-stm32h7")]
pub type Voice0Pin = embassy_stm32::peripherals::PA3;
#[cfg(feature = "mcu-stm32h7")]
pub type Voice0Timer = embassy_stm32::peripherals::TIM2;
...
#[cfg(feature = "mcu-stm32h7")]
pub const BOOT_LOG: &str = "Pocket synth STM32H743ZI: HSI SYSCLK, USB clock PLL3_Q 48 MHz from STLINK MCO | LED D6/PE9 | Melody A0/PA3 | Bass D0/PB7";
...
pub fn spawn_board_tasks(spawner: &Spawner, p: Peripherals) {
    spawner
        ...
        .unwrap();
    spawner
        .spawn(crate::voice::voice0_task(p.TIM2, p.PA3))
        .unwrap();
    spawn_shared_tasks(
        spawner,
        p.TIM4,
